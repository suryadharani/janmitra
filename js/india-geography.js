...
export const INDIA_GEOGRAPHY = {
  // --- STATES (28) ---
  "Andhra Pradesh": [
    "Alluri Sitharama Raju", "Anakapalli", "Ananthapuramu", "Annamayya", "Bapatla", 
    "Chittoor", "Dr. B.R. Ambedkar Konaseema", "East Godavari", "Eluru", "Guntur", 
    "Kakinada", "Kurnool", "NTR", "Nandyal", "Palnadu", "Parvathipuram Manyam", 
  ...
  "Punjab": [
    ...
    "Moga", "Pathankot", "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar", "Shahid Bhagat Singh Nagar", 
  ...
  "Rajasthan": [
    ...
    "Dholpur", "Didwana-Kuchaman", "Dungarpur", "Gangapur City", "Hanumangarh", "Jaipur", 
...
// Returns sorted list of Districts for a given State/UT
